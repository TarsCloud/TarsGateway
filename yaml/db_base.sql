...
) ENGINE=InnoDB CHARSET=utf8mb4 COMMENT='ip 黑名单';
...
) ENGINE=InnoDB CHARSET=utf8mb4 COMMENT='流量控制';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB CHARSET=utf8mb4 COMMENT='路由规则';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB CHARSET=utf8mb4 COMMENT='站点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB CHARSET=utf8mb4 COMMENT='后端服务地址';
/*!40101 SET character_set_client = @saved_cs_client */;
